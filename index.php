...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px black;background: lavender;">
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:whitesmoke;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;color: #373737;"><b>One Bank for <br> All Your Needs!</b></p>
                    <!-- HTML !-->
<a href="send_money.php" style=" color: transparent;"> <button class="button-12" role="button">transfer Money</button></a>
...
.button-12:focus {
  ...
  outline: 0;
            ...
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="images/bankicon.png" class="zoomin" alt="" style="width:0% ;">
            </div>
        </div>
    </div>
...
<hr style="border: solid;">
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;color: #373737;"><b>Our Provisions</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#373737; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
